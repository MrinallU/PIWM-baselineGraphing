...
GOKU_CARTPOLE_WEIGHTS_PATH = "./goku_lunar_weights_10_noise.pth"
VID2PARA_CARTPOLE_WEIGHTS_PATH = "./v2p_lunar_weights_10_noise.pth"
DVBF_CARTPOLE_WEIGHTS_PATH = "./dvbf_lunar_weights_10_noise.pth"
