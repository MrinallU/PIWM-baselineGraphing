...
GOKU_CARTPOLE_WEIGHTS_PATH = "./goku_cartpole_weights_5_noise.pth"
VID2PARA_CARTPOLE_WEIGHTS_PATH = "./v2p_cartpole_weights_5_noise.pth"
DVBF_CARTPOLE_WEIGHTS_PATH = "./dvfb_cartpole_weights_5_noise.pth"
SINDYC_CARTPOLE_WEIGHTS_PATH = "./sindyc_cartpole_weights_5_noise.pth"
